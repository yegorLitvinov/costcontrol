...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "kind",
                    models.CharField(
                        choices=[("proceed", "Proceed"), ("spending", "Spending")],
                        max_length=10,
                    ),
                ),
                (
        ...
        # Delete old models
        migrations.RemoveField(model_name="proceed", name="category"),
        migrations.RemoveField(model_name="proceed", name="user"),
        migrations.RemoveField(model_name="proceedcategory", name="user"),
        migrations.RemoveField(model_name="spending", name="category"),
        migrations.RemoveField(model_name="spending", name="user"),
        migrations.RemoveField(model_name="spendingcategory", name="user"),
        migrations.DeleteModel(name="Proceed"),
        migrations.DeleteModel(name="ProceedCategory"),
        migrations.DeleteModel(name="Spending"),
        migrations.DeleteModel(name="SpendingCategory"),
    ]
